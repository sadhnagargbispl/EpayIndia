<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="KitMaster.aspx.cs" Inherits="KitMaster" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Kit Master</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <Columns>
                                         ...
                                         <%--   <asp:BoundField DataField="BV" HeaderText="BV" />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center" ControlStyle-CssClass="btn-group">
                                                <ItemTemplate>
                                                    <a href='<%# "AddKit.aspx?KitId=" + HttpUtility.UrlEncode(Crypto.Encrypt(Eval("VKitId").ToString())) %>'>
