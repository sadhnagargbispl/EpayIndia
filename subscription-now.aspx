<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="subscription-now.aspx.cs" Inherits="subscription_now" %>
    ...
    <style>
        ...
        .sub-pkg-card {
            ...
            .sub-pkg-card:hover {
                ...
                box-shadow: 0 20px 50px rgba(232,64,0,.13);
            ...
            /* Popular badge */
            .sub-pkg-card.popular {
                border-color: var(--orange);
            }

                .sub-pkg-card.popular::before {
        ...
        .sub-pkg-btn {
            ...
            .sub-pkg-btn:hover {
                ...
                box-shadow: 0 10px 28px rgba(232,64,0,.42);
            }

        .sub-pkg-card.popular .sub-pkg-btn {
            box-shadow: 0 6px 20px rgba(232,64,0,.35);
        }
        ...
        .sub-perk {
            ...
            .sub-perk:hover {
                ...
                box-shadow: 0 6px 20px rgba(232,64,0,.07);
                transform: translateY(-2px);
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="sub-hero">
        <div class="sub-hero-inner">
            ...
            <h1>Choose Your <span>ePay</span><br>
        ...
        <div class="sub-wrap">
            ...
            <div class="sub-packages-grid">
                <asp:Repeater ID="rptPackages"
                    ...
                    <ItemTemplate>
                        <div class='sub-pkg-card <%# Convert.ToInt32(Eval("KitId")) == 6 ? "popular" : "" %>' data-anim>
                            ...
                            <div class="sub-pkg-header">
                                <div class="sub-pkg-icon">
                                    <%# Convert.ToInt32(Eval("KitId")) == 6 ? "🥈" : 
Convert.ToInt32(Eval("KitId")) == 4 ? "🥇" : "👑" %>
                                </div>
                                <div class="sub-pkg-name"><%# Eval("KitName") %></div>
                                <div class="sub-pkg-price"><span>₹</span><%# Eval("JoinAmount") %></div>
                            </div>
