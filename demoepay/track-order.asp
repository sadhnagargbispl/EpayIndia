...
<title>Track Order – ePay Digital India Pvt. Ltd.</title>
...
<section class="page-hero">
  <div class="page-hero-inner">
    <div class="page-hero-badge">&#10003; Order Status</div>
    <h1>Track <span>Your Order</span></h1>
    <p>Stay updated with real-time tracking of your orders. Enter your order ID to check the current delivery status.</p>
  </div>
</section>
...
<div class="page-content">
  <div class="coming-soon-box">
    ...
    <p>We are currently working on this page. The order tracking feature will be available here shortly.</p>
  </div>
</div>
