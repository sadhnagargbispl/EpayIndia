...
<style>
  ...
  .cert-wrap { max-width: 1100px; margin: auto; }
  ...
  .cert-section-label .line.left { background: linear-gradient(270deg, var(--border), transparent); }
  ...
  .lb-close:hover { background: var(--orange); transform: rotate(90deg); border-color: var(--orange); }
  ...
  @media (max-width: 520px) {
    ...
    .cert-section { padding: 40px 14px 60px; }
    .pg-hero { padding: 50px 16px 44px; }
    .lb-nav { width: 38px; height: 38px; font-size: 1rem; }
    .lb-prev { left: 8px; }
    .lb-next { right: 8px; }
    .lb-img-wrap img { max-width: 92vw; max-height: 75vh; }
  }
</style>
...
<div class="lb-overlay" id="lbOverlay" role="dialog" aria-modal="true" aria-label="Certificate Viewer">
  ...
  <!-- Prev / Next -->
  <button class="lb-nav lb-prev" id="lbPrev" title="Previous" aria-label="Previous">&#8249;</button>
  <button class="lb-nav lb-next" id="lbNext" title="Next" aria-label="Next">&#8250;</button>
...
<script>
  /* ── Lightbox Logic ── */
  var images = [
    'images/certificate/certificate_1.jpg',
    'images/certificate/certificate_2.jpg',
    'images/certificate/certificate_3.jpg',
    'images/certificate/certificate_4.jpg',
    'images/certificate/certificate_5.jpg'
  ];
