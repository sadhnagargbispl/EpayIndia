...
public partial class DailyIncentiveDetailReport : System.Web.UI.Page
{
    ...
    public void BindSession()
    {
        try
        {
            DataSet ds = SqlHelper.ExecuteDataset(constr1, "sp_GetWeeklySession");
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetWeeklyPayoutDetail", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=WeeklyIncentiveDetailReport.xlsx");
