...
public partial class Paymentgatewayapp : System.Web.UI.Page
{
    ...
    public string GenerateQrCode(string Orderid)
    {
        ...
        try
        {
            ...
            string sql_req = "INSERT INTO Tbl_ApiRequest_ResponsePaymentGateway " +
                             ...
                             "', 'AppLoginClaimLoginMonth', '" + Orderid + "','Paymentgatewayapp')";
            ...
            string sql_res = "UPDATE Tbl_ApiRequest_ResponsePaymentGateway SET Response = '" + str +
                             "' WHERE ReqID = '" + sResult +
                             "' AND Req_From = 'AppLoginClaimLoginMonth'";
    ...
    private string CheckLiveRateCoin(string auth, string orderid)
    {
        ...
        {
            File.AppendAllText(
                Server.MapPath("~/Logs/AppmonthlyStatusError.txt"),
                DateTime.Now +
                Environment.NewLine +
                ex.ToString() +
                Environment.NewLine);
            Response.Clear();
            Response.Redirect("~/Paymentgatewayapp.aspx?requestedId=" + orderid, false);
    ...
    //                         "(ReqID, Formno, Request, postdata, Req_From, OrderID,PageName) VALUES " +
    //                         "('" + sResult + "', '0', '" + UrlR + "', '" + UrlR +
    //                         "', 'AppStatusCheckClaimMonth', '" + orderid + "','Paymentgatewayapp')";
    ...
    //                         "' AND Req_From = 'AppStatusCheckClaimMonth'";
