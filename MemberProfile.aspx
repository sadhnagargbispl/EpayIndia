                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    <asp:Label ID="lblCount" runat="server" Style="font-weight: bold; font-size: 16px; color: black"></asp:Label>
                                                    <asp:Label ID="LabelActive" runat="server" Style="font-weight: bold; font-size: 16px; color: black"></asp:Label>
                                                    <asp:Label ID="lblinDeActive" runat="server" Style="font-weight: bold; font-size: 16px; color: black"></asp:Label>

                                                    <asp:Label ID="lblErr" runat="server" Style="font-weight: bold; font-size: 12px; color: black"></asp:Label>

                                                    <asp:Label ID="lblactive" runat="server" Style="font-weight: bold; font-size: 14px; color: black"></asp:Label>
                                                    <asp:Label ID="lbldeactive" runat="server" Style="font-weight: bold; font-size: 14px; color: black"></asp:Label>
