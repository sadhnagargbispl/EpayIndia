                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Virtual Investment</h3>
                            </div>
                            <div class="card-body">
                                <div align="center">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Enter Investment."
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <asp:Button ID="BtnFundTransfer" runat="server" Text="Add Investment" OnClientClick="return confirmation();"
