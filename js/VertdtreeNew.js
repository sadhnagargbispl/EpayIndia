...
function Node(id, pid, category, doj, name, nodename,
    ...
    leftjoin, rightjoin, level, upgradeDt, LeftCarryForward,
    RightCarryForward, IdNo, ActiveDirect, ActiveIndirect, IsBlock, BlockStatus, leftpv, rightpv, status) {
...
dTree.prototype.add = function (id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, LeftCarryForward, RightCarryForward, IdNo, ActiveDirect, ActiveIndirect, IsBlock, BlockStatus, leftpv, rightpv, status) {

    this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, LeftCarryForward, RightCarryForward, IdNo, ActiveDirect, ActiveIndirect, IsBlock, BlockStatus, leftpv, rightpv, status);
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.name + '</td>';
            strTable += '</tr>';
           ...
           // strTable += '<tr>';
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Joining Date :</font></td>';
            ...
            ////		strTable += '<tr>';
            ////		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total PV:</font></td>';
            ////		strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group A</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftpv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group B</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightpv + '</font></td></tr></table></font></td>';
            ////		
            ////		strTable += '</tr>';
            ...
            //		strTable += '</tr>';
            		strTable += '<tr>';
            		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>C/F PV :</font></td>';
        ...
        str += '<img id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + onMouse + ' alt="" height="50" width="50" />';
