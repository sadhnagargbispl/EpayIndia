...
public partial class Pool1Income : System.Web.UI.Page
{
    DAL objDAL = new DAL();
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetPool1IncomeReport", prms);
            ...
            Session["Pool1IncomeReport"] = Ds.Tables[0];
            ViewState["IdNo"] = "IdNo";
    ...
    private void ExportExcel()
    {
        try
        {
            DataTable dt = (DataTable)Session["Pool1IncomeReport"];
            using (XLWorkbook wb = new XLWorkbook())
            {
                wb.Worksheets.Add(dt, "Pool1IncomeReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=Pool1IncomeReport.xlsx");
    ...
    protected void GrdTotal1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            GvData1.DataSource = Session["Pool1IncomeReport"];
            GvData1.DataBind();
        }
        catch (Exception ex)
        {
