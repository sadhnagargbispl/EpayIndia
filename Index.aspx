...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="hero-slider" id="heroSlider">
        ...
        <!-- Prev / Next buttons -->
        <button type="button" type="button" class="slider-btn prev" id="heroPrev" aria-label="Previous slide">&#8249;</button>
        <button type="button" type="button" class="slider-btn next" id="heroNext" aria-label="Next slide">&#8250;</button>

        <!-- Dot indicators -->
        <div class="slider-dots" id="sliderDots">
            <button type="button" type="button" class="slider-dot active" data-index="0"></button>
            <button type="button" type="button" class="slider-dot" data-index="1"></button>
            <button type="button" type="button" class="slider-dot" data-index="2"></button>
        </div>
    ...
    <section class="section our-services-section">
        ...
        <div class="services-grid">
            ...
            <div class="service-card-live">
                ...
                <a href="StoreRedirect.aspx" target="_blank" class="service-link">Shop Now →</a>
            </div>
            ...
            <div class="service-card-live">
                ...
                <a href="BrandRedirect.aspx" target="_blank" class="service-link">Shop Now →</a>
            </div>
            ...
            <div class="service-card-live">
                ...
                <a href="UtilityServicesRedirect.aspx" target="_blank" class="service-link">Explore Now →</a>
            </div>
            ...
            <div class="service-card-live">
                ...
                <a href="GVRedirect.aspx" target="_blank" class="service-link">Buy Vouchers →</a>
            </div>
    ...
    <div class="upcoming-section">
        ...
        <div class="upcoming-banner">
            <div class="upcoming-content">
                ...
                <h2>Join <span class="premium-accent">ePay Premium</span> —<br>
    ...
    <section class="offers-section">
        ...
        <div class="categories-row">
            <button type="button" class="scroll-btn left" onclick="scrollCats(-1)">‹</button>
            ...
            <div class="categories-scroll" id="catsScroll">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <a href="https://store.epayindia.in/Home/ProductInfoContainer/1679183?pName=AKAI%20100%20Watts%20Bluetooth%20Speaker%20with%202%20Wireless%20Mic%20Karaoke%20System%20%7C%20Bluetooth%205.0%20Home%20Theatre%20Music%20System%20with%20Deep%20Bass%20Sound%20for%20TV,%20PC,%20Smartphone%20Music%20%26%20Movies%20%7C%20AUX%2FUSB%2FFM%20(Ultraboom-100)" target="_blank">
                            <button type="button" class="btn-cart">Add to Cart</button></a>
                    </div>
                </div>
            ...
            <button type="button" class="scroll-btn right" onclick="scrollCats(1)">›</button>
        </div>
    </section>
...
ePay focuses on delivering a secure, user-friendly, and scalable digital experience while enabling merchants and users to benefit from value-added services, rewards programs, and business growth opportunities in compliance with applicable guidelines and policies.
                </p>
