...
public partial class RankincomeReport : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        try
        {
            ...
            qry1 += "f.Comm as [Reward Income],F.Rate,F.Tokenval as [Token value],";
            qry1 += "Replace(Convert(Varchar,Isnull(c.ToDate,Getdate()),106),' ','-') as [Achieve Date] ";
            ...
            qry1 += "Left Join RankSummary as f on f.formno = a.formno ";
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry1 = "";
            //qry1 = ObjDal.IsoStart + " Select * from " + ObjDal.DBName + "..V#RewardNew Where 1=1 "+ ObjDal.IsoEnd;
            qry1 = "Select d.Idno as [Member IDNo],d.MemFirstName [Member Name],";
            qry1 += "f.Comm as [Reward Income],F.Rate,F.Tokenval as [Token value],";
            qry1 += "Replace(Convert(Varchar,Isnull(c.ToDate,Getdate()),106),' ','-') as [Achieve Date] ";
            qry1 += " from MstRankAchievers as A left join MstRanks As b on a.RankID = b.RankiD ";
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            {
                wb.Worksheets.Add(dt, "RankIncomeReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=RankIncomeReport.xlsx");
