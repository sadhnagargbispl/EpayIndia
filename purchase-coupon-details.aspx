<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="purchase-coupon-details.aspx.cs" Inherits="purchase_coupon_details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  ...
  ══════════════════════════════ */
        ...
        .cpd-info-row.amount-row {
            background: linear-gradient(135deg,#fff7ed,#ffedd5);
            border-color: rgba(232,64,0,.25);
        }

            .cpd-info-row.amount-row .cpd-info-val {
                color: var(--orange);
                font-size: 1.15rem;
            }
        ...
        .cpd-tab-content {
            ...
            .cpd-tab-content ul {
                ...
                .cpd-tab-content ul li {
                    ...
                    .cpd-tab-content ul li.tc::before {
                        content: '•';
  ...
  ══════════════════════════════ */
        ...
        .cpd-summary-row {
            ...
            .cpd-summary-row:last-child {
                border-bottom: none;
                font-weight: 800;
                font-size: .92rem;
            }

            .cpd-summary-row span:first-child {
                color: var(--muted);
            }

            .cpd-summary-row span:last-child {
                font-family: 'Sora',sans-serif;
                font-weight: 700;
                color: var(--text);
            }

            .cpd-summary-row.total span:last-child {
                color: var(--orange);
                font-size: 1rem;
            }
        ...
        @media (max-width: 480px) {
            .cpd-title-card, .cpd-info-card, .cpd-tabs-card {
                padding: 20px;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="cpd-breadcrumb">
        <div class="cpd-breadcrumb-inner">
            ...
            <a href="purchase-coupon.aspx">Purchase Coupon</a>
            <span class="cpd-breadcrumb-sep">›</span>
            ...
            <div class="cpd-layout">
                ...
                <div class="cpd-left">
                    ...
                    <div class="cpd-info-card">
                        ...
                        <div class="cpd-info-rows">
                            <div class="cpd-info-row amount-row">
                                <div class="cpd-info-row-left">
                                    ...
                                    <div>
                                        <div class="cpd-info-key">Wallet Balance</div>
                                        <div class="cpd-info-val">
                                            Rs.
                        ...
                        <asp:Button ID="BtnProceedToPay" runat="server" Text="💳 Process to Pay →" class="cpd-pay-btn" OnClick="BtnProceedToPay_Click" />
                    ...
                    <div class="cpd-coupon-wrap">
                        ...
                        <div class="cpd-coupon-card">
                            ...
                            <div class="cpd-coupon-body">
                                ...
                                <div class="cpd-c-divider">
                                    <div class="cpd-c-dline"></div>
                                </div>
                                <div class="cpd-c-right">
                                    ...
                                    <div class="cpd-c-orig">₹<asp:Label ID="LblAMount" runat="server" Text=""></asp:Label></div>
                                    <div class="cpd-c-wallet">₹<asp:Label ID="Lblwallet" runat="server" Text=""></asp:Label></div>
                                    <div class="cpd-c-save">Save ₹<asp:Label ID="LblSaveamount" runat="server" Text=""></asp:Label></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cpd-summary">
                            ...
                            <div class="cpd-summary-row">
                                ...
                                <span style="color: #dc2626;">− ₹<asp:Label ID="DiscountLess" runat="server" Text="" Style="color: #dc2626;"></asp:Label></span>
                            </div>
                            <div class="cpd-summary-row" style="display: none;">
                                <span>Wallet Credit</span>
                                <span style="color: var(--green);">₹<asp:Label ID="LblWalletCredit" runat="server" Text="" Style="color: var(--green);"></asp:Label></span>
                            </div>
                            <div class="cpd-summary-row total">
                                <span>You Pay</span>
                                <span>₹<asp:Label ID="LblYouPay" runat="server" Text=""></asp:Label></span>
                            </div>
                        </div>
