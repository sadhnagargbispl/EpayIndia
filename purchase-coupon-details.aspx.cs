...
public partial class purchase_coupon_details : System.Web.UI.Page
{
    ...
    public string Fund_Balance_Check()
    {
        ...
        try
        {
            ...
            string sql_req = "INSERT INTO Tbl_ApiRequest_Response(ReqID, Formno, Request, postdata, ForType) " +
                             "VALUES('" + sResult + "','" + Convert.ToInt32(HttpContext.Current.Session["FormNo"]) + "', '" + URL + "', '" + postData + "', 'BalancemasterWallet')";
            ...
            string sql_res = "Update Tbl_ApiRequest_Response Set Response = '" + Str.Trim() +
                             "' Where ReqID = '" + sResult.Trim() + "' AND ForType = 'BalancemasterWallet'";
    ...
    public string Fun_SameMasterDebitEntrty(string username, int kitid, decimal amount)
    {
        ...
        try
        {
            ...
            string sql_res = "UPDATE Tbl_ApiRequest_Response SET Response = '" + responseString.Trim() + "' WHERE ReqID = '" + sResult + "' AND ForType = 'MasterWalletDebit'";
            int x_res = Convert.ToInt32(SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["constr"].ConnectionString, CommandType.Text, sql_res));
        ...
        {
            string sql_res = "UPDATE Tbl_ApiRequest_Response SET Response = '" + ex.Message + "' WHERE ReqID = '" + sResult.Trim() + "' AND ForType = 'MasterWalletDebit'";
            int x_res = Convert.ToInt32(SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["constr"].ConnectionString, CommandType.Text, sql_res));
            status = "failed";
        }
