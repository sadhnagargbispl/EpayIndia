<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="purchase-coupon.aspx.cs" Inherits="purchase_coupon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        ...
        .food-card .coupon-disc-pct {
            color: var(--orange);
        }

        .movie-card .coupon-disc-pct {
            color: var(--green);
        }
        ...
        .food-card .coupon-tag.wallet {
            background: var(--og);
            color: var(--orange);
            border: 1px solid rgba(232,64,0,.22);
        }

        .movie-card .coupon-tag.wallet {
            background: var(--gg);
            color: var(--green);
        ...
        .food-card .coupon-btn {
            background: var(--orange);
            color: #fff;
            box-shadow: 0 5px 16px rgba(232,64,0,.3);
        }

        .movie-card .coupon-btn {
    ...
    <section class="cp-hero">
        <div class="cp-hero-inner">
            <div class="cp-hero-badge">
                <div class="cp-badge-dot"></div>
                ePay India — Purchase Coupon
            </div>
            <h1>Purchase <span>Coupons</span> &amp;<br>
                Save More Every Time</h1>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹3,000</div>
                                </div>
                            ...
                            <a href="purchase-coupon-details.aspx" class="coupon-btn">Buy Now →</a>
                        </div>
                    </div>
                </div>--%>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹6,000</div>
                                </div>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹12,000</div>
                                </div>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹2,500</div>
                                </div>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹5,000</div>
                                </div>
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹10,000</div>
                                </div>
                                <div class="coupon-wallet-price">₹6,000</div>
                                <div class="coupon-tags">
                    ...
                    <div class="coupon-body">
                        ...
                        <div class="coupon-right">
                            <div>
                                ...
                                <div class="coupon-price-row">
                                    <div class="coupon-price">₹25,000</div>
                                </div>
