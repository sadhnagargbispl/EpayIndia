...
public partial class LevelIncomeDetail : System.Web.UI.Page
{
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetActivationLevelCashbackReport", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            {
                wb.Worksheets.Add(dt, "ActivationLevelCashbackReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=ActivationLevelCashbackReport.xlsx");
