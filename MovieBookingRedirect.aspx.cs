    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                string url = "https://movie.epayindia.in/controller.aspx?user_info=" + encryptedUserInfo + "&log_key=14040576-4E2C-499B-A46B-7192579BA03E";
                Response.Redirect(url);
            }
            else
            {
                Response.Redirect("https://movie.epayindia.in/");
            }
        }
        catch (Exception ex)
        {
