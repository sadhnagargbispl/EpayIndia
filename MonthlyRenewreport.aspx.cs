...
public partial class MonthlyRenewreport : System.Web.UI.Page
{
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetRenewReporReport", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            {
                wb.Worksheets.Add(dt, "MonthlyRenewReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=MonthlyRenewReport.xlsx");
