...
public partial class PaymentGatewayPurchase : System.Web.UI.Page
{
    ...
    public string GenerateQrCode(string Orderid)
    {
        ...
        try
        {
            ...
            string sql_req = "INSERT INTO Tbl_ApiRequest_ResponsePaymentGateway " +
                             ...
                             "', 'AppLoginClaimLogin', '" + Orderid + "','PaymentGatewayPurchase')";
    ...
    private string CheckLiveRateCoin(string auth, string orderid)
    {
        ...
        {
            File.AppendAllText(
                Server.MapPath("~/Logs/AppsubscriptionStatusError.txt"),
                DateTime.Now +
                Environment.NewLine +
                ex.ToString() +
                Environment.NewLine);
            Response.Clear();
            Response.Redirect("~/PaymentGatewayPurchase.aspx?requestedId=" + orderid, false);
    ...
    //                         "(ReqID, Formno, Request, postdata, Req_From, OrderID,PageName) VALUES " +
    //                         "('" + sResult + "', '0', '" + UrlR + "', '" + UrlR +
    //                         "', 'AppStatusCheckClaim', '" + orderid + "','PaymentGatewayPurchase')";
    ...
    //                         "' AND Req_From = 'AppStatusCheckClaim'";
